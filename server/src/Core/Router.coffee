...
###
Router::findController = (controllers, decomposedUrl) ->
    i = undefined
    controllerName = undefined
    controllersArrayReverted = undefined
    controllersArray = []
    controllerNameCamelCase = undefined
...
Router::decompose = (requestUrl) ->
    ...
    controllerAppended = ""
    application = "app"
    urlFormatPart = undefined
    formatPartFirstChar = undefined
    type = "root"
    i = 0
    $this = this
    parts.forEach (part) ->
