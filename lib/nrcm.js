...
// Constructor
function NRCM() {
    this.exceptionsControllerFile = 'ExceptionsController.js';
...
NRCM.prototype.setUp = function(appName) {
    ...
    for (var name in app.components) {
        var Component = app.components[app];
...
NRCM.prototype.start = function(address, port) {
    ...
    var requestHandler = new RequestHandler(this.configs, this.applications);
